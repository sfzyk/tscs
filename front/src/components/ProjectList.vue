  ...
  <div>
    <el-card style="opacity:0.6">
      ...
      <div align="center">
        <el-row>
          ...
          <el-col :span="3" :offset="2">
            <div style="font-size: 15px;height=200px;" align="center">
              <sortButton ref="name_button" appearance="项目名称" @change-sort="sort_name"></sortButton>
            </div>
          </el-col>
          <el-col :span="3">
            <div style="font-size: 15px;height=200px;" align="center">
              <sortButton ref="contest_button" appearance="所在比赛" @change-sort="sort_contest"></sortButton>
            </div>
          </el-col>
          <el-col :span="3">
      ...
      <el-row>
        ...
        <el-col :span="3">
          <el-input placeholder prefix-icon="el-icon-search" v-model="searchcontest"></el-input>
        </el-col>
...
export default {
  ...
  watch: {
    ...
    searchcontest: function(newval, oldval) {
      this.searchFunction();
    },
  ...
  methods: {
    ...
    sort_contest(sort_type) {
      console.log(sort_type);
      this.sortfield = "contest__name";
      this.sortorder = sort_type;
      this.searchFunction();
